const artEl = document.querySelector("#focus-art");
const titleEl = document.querySelector("#focus-title");
const artistEl = document.querySelector("#focus-artist");
const languageEl = document.querySelector("#focus-language");
const emptyEl = document.querySelector("#focus-empty");
const lyricsEl = document.querySelector("#focus-lyrics");
const originalEl = document.querySelector("#focus-original");
const romanizedEl = document.querySelector("#focus-romanized");
const translatedEl = document.querySelector("#focus-translated");
const prevEl = document.querySelector("#focus-prev");
const nextEl = document.querySelector("#focus-next");
const statusEl = document.querySelector("#focus-status");
const translationEl = document.querySelector("#focus-translation");
const syncEl = document.querySelector("#focus-sync");
const sourceEl = document.querySelector("#focus-source");
const preparingEl = document.querySelector("#focus-preparing");
const preparingArtEl = document.querySelector("#focus-preparing-art");
const romanizationToggleEl = document.querySelector("#focus-romanization-toggle");
const progressFillEl = document.querySelector("#focus-progress-fill");
const elapsedTimeEl = document.querySelector("#focus-elapsed");
const durationTimeEl = document.querySelector("#focus-duration");
const reloadEl = document.querySelector("#focus-reload");
const playToggleEl = document.querySelector("#focus-play-toggle");
const moreMenuEl = document.querySelector("#focus-more-menu");
const permissionEl = document.querySelector("#focus-permission");
const setupEl = document.querySelector("#focus-setup");
const setupOpenEl = document.querySelector("#focus-setup-open");
const setupPermissionEl = document.querySelector("#focus-setup-permission");
const setupPlayEl = document.querySelector("#focus-setup-play");
const creditSongEl = document.querySelector("#focus-credit-song");
const creditArtistEl = document.querySelector("#focus-credit-artist");
const creditPlaybackEl = document.querySelector("#focus-credit-playback");
const creditPlaybackTextEl = document.querySelector("#focus-credit-playback-text");
const creditLyricsEl = document.querySelector("#focus-credit-lyrics");
const creditLyricsTextEl = document.querySelector("#focus-credit-lyrics-text");
const creditTranslationEl = document.querySelector("#focus-credit-translation");
const qualityEl = document.querySelector("#focus-quality");
...
let showRomanization = localStorage.getItem("lyric-focus-romanization") !== "off";
...
function renderRecentSongs(songs = []) {
  ...
  for (const song of songs) {
    ...
    button.className = "focus-recent-song";
    button.type = "button";
...
function setShowRomanization(value) {
  ...
  localStorage.setItem("lyric-focus-romanization", value ? "on" : "off");
...
function updateProgressBar() {
  ...
  const boundedElapsedMs = elapsedMs !== null
    ...
    : 0;
  const percent = elapsedMs !== null && durationMs
...
recentSongsEl.addEventListener("click", (event) => {
  const button = event.target.closest(".focus-recent-song");
